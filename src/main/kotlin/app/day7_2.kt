...
fun main() = runBlocking<Unit> {
    ...
    val allPhaseSettingsPartTwo = permutationsOf(mutableListOf(5, 6, 7, 8, 9))
    assert(allPhaseSettingsPartTwo.size == 120)
    val maxOutput2 = allPhaseSettingsPartTwo.map { software.maxSignal(it, memory.clone()) }.max()
    println("Max value for part two = $maxOutput2")
}